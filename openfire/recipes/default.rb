...
cookbook_file "/etc/openfire/security/client.truststore" do
  mode '0644'
end

cookbook_file "/etc/openfire/security/keystore" do
  mode '0644'
end

cookbook_file "/etc/openfire/security/truststore" do
  mode '0644'
end

# this file contains max of conection
...
#execute "service openfire restart"
service "openfire" do
